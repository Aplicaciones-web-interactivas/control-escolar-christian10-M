...
// Alumno: ver tarea y subir entrega
Route::middleware(['rol:alumno'])->group(function () {
Route::get('/tareas/{tarea}/subir', [TareaController::class, 'verTarea']);
Route::post('/tareas/{tarea}/subir', [TareaController::class, 'subirEntrega']);
});

// Maestro y admin: ver grupos, tareas y entregas
Route::middleware(['rol:admin,maestro'])->group(function () {
Route::get('/tareas/grupo/{grupo}', [TareaController::class, 'verGrupo']);
Route::get('/tareas/grupo/{grupo}/crear', [TareaController::class, 'create']);
Route::post('/tareas/grupo/{grupo}/crear', [TareaController::class, 'store']);
